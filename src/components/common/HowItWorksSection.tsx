        ...
        <div className="hidden md:block relative mt-8">
          <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-full max-w-4xl">
            <div className="flex justify-between items-center relative">
              ...
              <div className="w-1/3 border-t-2 border-dashed border-border relative">
                <div className="absolute top-0 right-0 w-0 h-0 border-l-8 border-l-border border-t-4 border-t-transparent border-b-4 border-b-transparent transform translate-x-1"></div>
              </div>
              <div className="w-1/3 border-t-2 border-dashed border-border relative">
                <div className="absolute top-0 right-0 w-0 h-0 border-l-8 border-l-border border-t-4 border-t-transparent border-b-4 border-b-transparent transform translate-x-1"></div>
              </div>
